          ...
          <div className="row">
            ...
            {Object.keys(items).map((item) => {
              if (!excluded.includes(item)) {
                return (
                  <Link to={`/${item}`} state={items[item]} className="card col-auto nav-link stretched-link" style={{ width: "18rem" }}>
                    
                        <img src="..." className="card-img-top" alt="..." />
                        <div className="card-body">
                          <h2 className="card-title nav-link stretched-link">{item}</h2>
                        </div>
